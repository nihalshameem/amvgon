      ...
      <div class="card-body">
        ...
        <div class="d-flex align-items-end flex-wrap">
          ...
          <div class="d-flex">
            ...
            <p class="text-primary mb-0 hover-cursor"><a  href="/admin/products">new banner</a></p>
          </div>
        </div>
      </div>
        <form class="form-sample mt-3" method="POST" action="/admin/banner/add/submit" enctype="multipart/form-data">
            @csrf
          <div class="row">
            <div class="col-md-6">
