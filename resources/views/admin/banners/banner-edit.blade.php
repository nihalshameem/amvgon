      ...
      <div class="card-body">
        ...
        <div class="d-flex align-items-end flex-wrap">
          ...
          <div class="d-flex">
            ...
            <p class="text-primary mb-0 hover-cursor"><a  href="/admin/products">edit banner</a></p>
          </div>
        </div>
      </div>
        <form class="form-sample mt-3" method="POST" action="/admin/banner/edit/{{$banner->id}}" enctype="multipart/form-data">
            @csrf
          <div class="row">
            <div class="col-md-6">
        ...
        <form action="/admin/banner/detele/{{$banner->id}}" method="post">
          @csrf
