      ...
      <div class="card-body">
        <div class="d-flex justify-content-between flex-wrap">
          <div class="d-flex align-items-end flex-wrap">
            ...
            <p class="text-primary mb-0 hover-cursor"><a  href="/admin/offer-banners">offer-banners list</a></p>
            </div>
          </div>
          @if (count($banners) < 3)
          ...
          <div class="d-flex justify-content-between align-items-end flex-wrap">
            <button href="" type="button" class="btn btn-light bg-white btn-icon mr-3 mt-2 mt-xl-0">
              <a href="/admin/offer-banner/add"> <i class="mdi mdi-plus text-muted"></i></a>
            </button>
          </div>
          @endif
        </div>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/admin/offer-banner/{{$banner->id}}" type="button" class="btn btn-sm btn-inverse-dark"><i class="mdi mdi-pencil"></i></a>
              </td>
              </tr>
          @endforeach
              @else
